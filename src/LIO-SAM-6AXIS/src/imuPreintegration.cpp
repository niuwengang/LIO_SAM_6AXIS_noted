...
class TransformFusion : public ParamServer
{
  public:
    ...
    TransformFusion()
    {
        ...
        subLaserOdometry = nh.subscribe<nav_msgs::Odometry>("lio_sam_6axis/mapping/odometry", 5,
  ...
  public:
    ...
    IMUPreintegration()
    {
        subImu = nh.subscribe<sensor_msgs::Imu>(imuTopic, 2000, &IMUPreintegration::imuHandler, this,
                                                ros::TransportHints().tcpNoDelay());
        subOdometry = nh.subscribe<nav_msgs::Odometry>("lio_sam_6axis/mapping/odometry_incremental", 5,
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr &imu_raw)
    {
        ...
        sensor_msgs::Imu thisImu = imuConverter(*imu_raw); // 将imu转换到雷达坐标系
...
int main(int argc, char **argv)
{
    ...
    ros::MultiThreadedSpinner spinner(4); // 4线程处理回调
    spinner.spin();
